#!/usr/bin/env python3
"""
UCASS 1 / 2 / 6 multi-bin intercomparison — 5-minute bins, wind split at 4 m/s.
...
OUTPUT_FIGURE = OUTPUT_DIR / "UCASS_multi_bin_intercomparison_scatter_5min_by_wind_4ms.png"
OUTPUT_CSV = OUTPUT_DIR / "UCASS_multi_bin_scatter_5min_by_wind_4ms.csv"
...
def main() -> None:
    ...
    print("\nUCASS multi-bin intercomparison — 5-minute bins, wind split at 4 m/s")
    print("=" * 60)
