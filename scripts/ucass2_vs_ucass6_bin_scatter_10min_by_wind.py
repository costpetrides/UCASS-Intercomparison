#!/usr/bin/env python3
"""
UCASS 2 vs UCASS 6 — 10-minute scatter coloured by mean wind speed.
...
OUTPUT_PNG = OUTPUT_DIR / "UCASS2_vs_UCASS6_bin_scatter_10min_by_wind.png"
OUTPUT_CSV = OUTPUT_DIR / "UCASS2_vs_UCASS6_bin_scatter_10min_by_wind.csv"
FIGURE_DPI = 300
AGG_INTERVAL = "10min"
...
def main() -> None:
    ...
    print("UCASS 2 vs UCASS 6 — 10-minute scatter by mean wind speed")
    print("=" * 60)
